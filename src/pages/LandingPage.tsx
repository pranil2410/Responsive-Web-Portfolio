    ...
    <div className="w-full min-h-screen relative grid-bg pt-8 pb-16 px-6">
      ...
      <section className="max-w-4xl mx-auto text-center mt-12 mb-16 relative">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-extrabold tracking-tight bg-gradient-to-r from-white via-gray-300 to-purple-400 bg-clip-text text-transparent pb-3 mb-3"
        >
          Pranil Belge
        </motion.h1>
